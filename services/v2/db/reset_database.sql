...
CREATE TABLE db_upgrades ( upgrade_id INT(32) UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id INT(32) UNSIGNED NOT NULL, version_major INT(32) UNSIGNED NOT NULL, version_minor INT(32) UNSIGNED NOT NULL, timestamp TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
...
curated TINYINT(1) UNSIGNED NOT NULL DEFAULT '0',
sort_index INT(32) NOT NULL,
created TIMESTAMP DEFAULT '0000-00-00 00:00:00',
last_active TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
);
...
infinite_distance TINYINT(1) UNSIGNED NOT NULL DEFAULT 0,
